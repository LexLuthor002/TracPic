      ...
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className="font-display font-bold text-xl tracking-wide hidden sm:block">
            TRAC <span className="text-primary">GAMING</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-center gap-2 bg-white text-black px-5 py-2.5 rounded-full font-semibold text-sm hover:bg-white/90 hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]">
